    ...
    <header className="flex-shrink-0 flex items-center gap-3 sm:gap-6 px-4 sm:px-8 py-4 sm:py-5 border-b z-30"
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={dropdownRef}>
          <button 
            ...
            className={cn(
              ...
              showNotifications ? "bg-orange-500 text-white shadow-lg shadow-orange-500/20" : "bg-slate-50 text-slate-400 hover:text-white border border-slate-200"
            )}
          >
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
          <div className="w-11 h-11 rounded-2xl gradient-blue flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-orange-500/10">
